...
namespace Engine.Models
{
    public interface IModel
    {
        ...
        void AddComponent(string componentName, string characteristicName = null);
        void AddFunction(string functionName);
        void AddRule(Rule rule);
        IEnumerable<Rule> GetRules(string id);
        void AddParameter(string collectionId, SqlParameter parameter);
        SqlParameter[] GetParameters(string collectionId);
    }
